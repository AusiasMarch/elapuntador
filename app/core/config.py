...
FIRST_SUJETO_NAME = get_env_variable("FIRST_SUJETO_NAME")
FIRST_SUJETO_APODOS = get_env_variable("FIRST_SUJETO_APODOS")
FIRST_SUJETO_BIRTH = get_env_variable("FIRST_SUJETO_BIRTH")
FIRST_SUJETO_GENDER = get_env_variable("FIRST_SUJETO_GENDER")
